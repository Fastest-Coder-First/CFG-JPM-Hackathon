...
import EventItem from "../EventItem/NewsItem";
  ...
  articles = [
    {
      ...
      urlToImage:
        "https://yt3.ggpht.com/ytc/AKedOLS12L6sNspqDM4I64CHgFSVfAdNqU7xNvDmkHdE=s900-c-k-c0x00ffffff-no-rjg",
        ...
        <div className="row">
          {this.state.articles.map((element) => {
            return <div className="col-md-4" key={element.source.id}>
                        <EventItem title={element.title} description={element.description} imageUrl={element.urlToImage} newsUrl={element.url}/>
                    </div>
          })}
        </div>
      </div>
